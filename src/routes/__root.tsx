  ...
  head: () => ({
    meta: [
      ...
      { title: "Dadar Shop — Shop Anything, Beautifully" },
      {
        name: "description",
        content:
          "A premium mobile-first marketplace for Bangladesh. Curated products, verified sellers, fast delivery.",
      },
      { name: "theme-color", content: "#FAF8F3" },
      { property: "og:title", content: "Dadar Shop" },
      { property: "og:description", content: "Shop anything, beautifully." },
